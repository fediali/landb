...
$(document).ready(function () {
    ...
    function dp_scroll_text() {
        ...
        $('#vslider1').attr("src", "http://revamp.landbw.co/img/pr2.png");
        $('#vslider2').attr("src", "http://revamp.landbw.co/img/pr2.png");
        $('#vslider3').attr("src", "http://revamp.landbw.co/img/pr2.png");
        $('#vslider4').attr("src", "http://revamp.landbw.co/img/pr2.png");
        $('#vslider5').attr("src", "http://revamp.landbw.co/img/pr2.png");
        $('#vslider6').attr("src", "http://revamp.landbw.co/img/pr2.png");

...
@section('content')
    ...
    <div class="p-3 bg-white">
        ...
        <div id="main">
            ...
            <div class="row">
                <div class="col-lg-12 mb-3">
                    <h5 class="order-detail">Examples</h5>
                </div>
                        ...
                        <div class="carousel-inner">
                            @foreach($images as $image)
                                <div class="carousel-item @if($loop->first) active @endif">
                                    <img height="400px" style="object-fit: cover" class="d-block w-100"
                                         src="{{ asset('storage/'.$image) }}" alt="{{$loop->iteration}} slide">
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header msg_head">
                            <div class="d-flex bd-highlight">
                                <div class="img_cont">
                                    <img height="70" width="70" src="{{ asset('images/chat-bubble.png') }}"
                                         class="user_img">
                                </div>
                                <div class="user_info">
                        ...
                        <div class="card-footer">
                            <form id="commentForm" method="post" action="{{ route('sourcing.create') }}"
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="comment_input" required type="text" name="name"
                                           class="form-control type_msg" placeholder="Name here...">
                                    <div class="input-group-append">
                                        <span class="input-group-text send_btn"><button type="submit"
                                                                                        id="completed-task"
                                                                                        class="fabutton"><i
                                ...
                                <br>
                                <textarea id="comment_input" required name="notes" class="form-control type_msg"
                                          placeholder="Notes here..."></textarea><br>

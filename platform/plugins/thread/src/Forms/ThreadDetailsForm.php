    ...
    public function buildForm()
    {
        ...
        $this->setupModel(new Thread)
            ...
            ->add('Details', 'threadDetails', [
                    'label' => 'Details',
                    'data' => ['thread' => $this->model, 'photographers' => $photographers, 'printdesigns' => $printdesigns, 'variations' => $variations, 'seasons' => $seasons, 'rises' => $rises, 'fits' => $fits, 'fabrics' => $fabrics, 'washes' => $wash, 'reg_cat' => $reg_cat, 'plus_cat' => $plus_cat, 'reg_sku' => $reg_sku, 'plus_sku' => $plus_sku]
                ]
            )

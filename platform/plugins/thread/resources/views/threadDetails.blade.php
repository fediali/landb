                                                ...
                                                <div class="container">
                                                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                                        ...
                                                        <ol class="carousel-indicators">
                                                            @foreach($thread->spec_files as $specfile)
                                                                <li data-target="#myCarousel" data-slide-to="{{ $loop->iteration - 1 }}"
                                                        ...
                                                        <div class="carousel-inner">
                                                            @foreach($thread->spec_files as $specfile)
                                                                <div class="item {{ $loop->first ? 'active' : '' }}">
                                                                    <img
                                                                        src="{{ asset($specfile->spec_file) }}"
                                                                        alt="{{ $thread->name }}" style="width:100%;">
                                                                </div>
                                                            @endforeach
                                                        </div>

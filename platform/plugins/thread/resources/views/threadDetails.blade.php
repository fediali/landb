         ...
         <tbody>
            ...
            <tr>
               <td style="width: 14%;border: 1px solid #333;  padding:0px 10px;">
                  <p style="font-size: 12px !important; font-weight: 600; font-family: 'Raleway', sans-serif;margin: 0px;">Style # <br>
               ...
               <td style="border: 1px solid #333;  padding:0px 10px;" colspan="2">
                  <p style="font-size: 12px !important; font-weight: 600; font-family: 'Raleway', sans-serif;margin: 0px;">Season: <br>
                     <span style="color: #f36a5a; text-transform: uppercase !important; font-weight: 400; ">  {{ @$thread->season->name }}</span>
                  </p>
               </td>
               <td style="border: 1px solid #333;  padding:0px 10px;" colspan="2">
                  <p style="font-size: 12px !important; font-weight: 600; font-family: 'Raleway', sans-serif;margin: 0px;">Vendor: <br>
               ...
               <td style="border: 1px solid #333;  padding:0px 10px;" colspan="1">
                  <p style="font-size: 12px !important; font-weight: 600; font-family: 'Raleway', sans-serif;margin: 0px;">Status: <br>
            ...
            <tr>
               <td style="border: 1px solid #333;  padding:0px 10px;" colspan="3">
                  <p style="font-size: 12px !important; font-weight: 600; font-family: 'Raleway', sans-serif;margin: 0px;">Shipping Method: <br>
                     <span style="color: #f36a5a; text-transform: uppercase !important; font-weight: 400; "> {{ $thread->shipping_method }}</span>
                  </p>
               </td>
               <td style="border: 1px solid #333;  padding:0px 10px;" colspan="3">
                  <p style="font-size: 12px !important; font-weight: 600; font-family: 'Raleway', sans-serif;margin: 0px;">Ship Date: <br>
               ...
               <td style="border: 1px solid #333;  padding:0px 10px;" colspan="4">
                  <p style="font-size: 12px !important; font-weight: 600; font-family: 'Raleway', sans-serif;margin: 0px;">No Later Than <br>
            ...
            <div style="    flex: 0 0 73.76667%;
               ...
               <div>
                  <h4 style="    text-align: center;
                     font-size: 16px;
                     text-transform: uppercase;
                     margin: 0; font-family: 'Raleway', sans-serif;">Order</h4>
                  <div>
                     <table style="border: 1px solid #333;
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td style="border: 1px solid #333;  padding:0px 10px;" rowspan="2">
                                 <p style="font-size: 12px !important; font-weight: 600; font-family: 'Raleway', sans-serif;margin: 0px;">Label:
                           ...
                           <tr>
                              <td style="border: 1px solid #333;  padding:0px 10px;">
                                 <p style="font-size: 12px !important; font-weight: 600; font-family: 'Raleway', sans-serif;margin: 0px;">Sleeve Length:
                                 ...
                                 <div style="background: #f5f5f5; padding: 10px; border-radius: 5px;">
                                  ...
                                  @if($variation->status == 'active' && $variation->is_denim == 0)
                                       <div style=" flex: 0 0 44.333333%; max-width: 44.333333%; position: relative; width: 100%; padding-right: 15px; padding-left: 15px;">
                                          <div style="background: #ffffff;  border: 1px solid #d0d0d0;  border-radius: 10px; padding-left: 1rem !important; padding-right: 1rem !important; ">

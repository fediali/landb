@if ($thread->is_denim == 1)
    <div id="DivDenimToPrint">
        ...
        <table style="border: 1px solid #333;border-collapse: collapse; border-spacing: 0; width: 100%; margin-top: 15px;">
            ...
            <tr>
                ...
                <td style="width: 12%; border: 1px solid #333; padding:10px;" colspan="1" rowspan="1">
                    <p style="font-size: 12px !important; font-weight: 600; font-family: Madeglin, sans-serif; margin: 0px;">Order Date:<br>
                ...
                <td style="border: 1px solid #333;  padding:0px 10px;" rowspan="1" colspan="1">
                    <p style="font-size: 12px !important; font-weight: 600; font-family: Madeglin, sans-serif;margin: 0px;">Description <br>
                ...
                <td style="border: 1px solid #333;  padding:0px 10px;" colspan="1">
                    <p style="font-size: 12px !important; font-weight: 600; font-family: Madeglin, sans-serif;margin: 0px;">Designer: <br>
                ...
                @if(!empty($plus_cat))
                    <td style="width: 8%;border: 1px solid #333; vertical-align: top;" colspan="1" rowspan="2" class="p-0">
                        <div class="regpack">
                            <h6 style="font-size: 12px; margin:0px; background: #333;  font-family: Madeglin, sans-serif; color: #fff; padding: 4px; text-align: center; text-transform: uppercase; font-weight: 400;">Plus Pack Size</h6>
                            @if($plus_cat)
                ...
                <td style="width: 13%;border: 1px solid #333;  padding:0px 10px;" rowspan="1" colspan="2">
                    <p style="font-size: 12px !important; font-weight: 600; font-family: Madeglin, sans-serif;margin: 0px;">PP Sample Due Date <br>
                ...
                <td style="border: 1px solid #333;  padding:0px 10px;" colspan="2">
                    <p style="font-size: 12px !important; font-weight: 600; font-family: Madeglin, sans-serif;margin: 0px;">Request PP Sample: <br>
                ...
                <td style="border: 1px solid #333;  padding:0px 10px;">
                    <p style="font-size: 12px !important; font-weight: 600; font-family: Madeglin, sans-serif;margin: 0px;">PP Sample Size: <br>
            ...
            <tr>
                ...
                <td colspan="2" style="width: 14%;border: 1px solid #333;  padding:0px 10px;">
                    <p style="font-size: 12px !important; font-weight: 600; font-family: Madeglin, sans-serif;margin: 0px;">Category <br>
                        <span style="color: #f36a5a; text-transform: uppercase !important; font-weight: 400; ">
        ...
        <div style="margin: 30px 0;border: solid 1px #333;padding: 15px;border-radius: 5px;">
            <div style=" display: flex;margin-right: -15px;margin-left: -15px;">
                <div style=" flex: 0 0 20.333333%;max-width: 20.333333%; position: relative;width: 100%;padding-right: 15px;padding-left: 15px;">
                    <h4 style=" text-align: center;font-size: 16px;text-transform: uppercase;margin: 0; font-family: Madeglin, sans-serif;">Style</h4>
                ...
                <div style="flex: 0 0 74.76667%;max-width: 74.76667%; position: relative;width: 100%;padding-right: 15px;padding-left: 15px;">
                    <div>
                        <h4 style="text-align: center;font-size: 16px;text-transform: uppercase;margin: 0; font-family: Madeglin, sans-serif;">SPECIFICATIONS</h4>
                        <div class="denim_table">
                            <table style="border: 1px solid #333;border-collapse: collapse;height: 100%; width: 100%;">
                                <thead>
                                <tr>
                                    <th style=" font-weight: 600; font-family: Madeglin, sans-serif;padding: 8px; vertical-align: top;  font-size: 14px;" colspan="1" rowspan="1">Inseam: {{ $thread->inseam }}</th>
                                    <th style=" font-weight: 600; font-family: Madeglin, sans-serif;padding: 8px; vertical-align: top;  font-size: 14px;" colspan="1" rowspan="1">Label: {{ @$thread->label }}</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <td style="background: #ff442e; font-weight: 600; font-family: Madeglin, sans-serif; border: 1px solid #333; padding: 8px; vertical-align: top;  font-size: 14px;" colspan="12">
                                            ...
                                            @foreach(array_chunk($fits, 5, true) as $fits)
                                                <div class="item">
                                                    @foreach($fits as $key => $fit)
                                                        <div style=" font-weight: 600; font-family: Madeglin, sans-serif;display: flex;  justify-content: space-between; align-items: baseline;">
                                                            <label for=""> {{ $fit }}</label>
        ...
        cursor: default;  opacity: 1.65 !important;" type="checkbox" disabled {!! ($key == $thread->rise_id) ? 'checked' : '' !!}>
                                ...
                                <tr>
                                    <td style=" font-weight: 600; font-family: Madeglin, sans-serif; border: 1px solid #333; padding: 8px; vertical-align: top;  font-size: 14px;" colspan="12">
                                        <div style=" font-weight: 600; font-family: Madeglin, sans-serif;display: flex; justify-content: space-between;">
                                ...
                                <tr>
                                    <td style=" font-weight: 600; font-family: Madeglin, sans-serif; border: 1px solid #333; padding: 8px; vertical-align: top;  font-size: 14px;" colspan="12">
                                        <div style=" font-weight: 600; font-family: Madeglin, sans-serif; display: flex !important;">
                                            <div style="display: flex;flex-wrap: wrap;margin-right: -15px;margin-left: -15px;">
                                                <div style=" font-weight: 600; font-family: Madeglin, sans-serif; flex: 0 0 50%;max-width: 50%; position: relative;width: 100%;padding-right: 15px;padding-left: 15px;">
                                                    <div style="background: #ffffff;border: 1px solid #d0d0d0;border-radius: 10px; margin-bottom: 1rem !important; padding-right: 1rem !important; padding-left: 1rem !important; font-weight: 600; font-family: Madeglin, sans-serif;">
                                                        @foreach($variations as $variation)
                                                            @if($variation->status == 'active' && $variation->is_denim == 1)
                                                                {{--<h5 class=" mt-2">{{$loop->iteration}}. Variation: {{$variation->name}}</h5>--}}
                                                                <div style=" font-weight: 600; font-family: Madeglin, sans-serif; display: flex;flex-wrap: wrap;margin-right: -15px;margin-left: -15px;">
                                                                    <div style=" font-weight: 600; font-family: Madeglin, sans-serif;flex: 0 0 40%;max-width: 40%;position: relative;width: 100%;padding-right: 15px;padding-left: 15px;">
                                                                        ...
                                                                        <img height="120" style=" font-weight: 600; font-family: Madeglin, sans-serif;object-fit: cover;width: 100% !important;" src="{{ asset('storage/'.strtolower(@$variation->printdesign->file)) }}"/>
                                                                    </div>
                                                                        ...
                                                                        <div style=" font-weight: 600; font-family: Madeglin, sans-serif;flex: 0 0 40%;max-width: 40%; position: relative;width: 100%;padding-right: 15px;padding-left: 15px;">
                                                                            <p style=" font-weight: 600; font-family: Madeglin, sans-serif; margin-bottom: 0 !important; margin-top: 0.5rem !important;">
                                                                                ...
                                                                                <a href="{{ route('thread.removeFabric', $fabric->id) }}">
                                                                                    <strong style=" font-weight: 600; font-family: Madeglin, sans-serif;float: right !important;">
                                                                                        <i class="fa fa-times"></i>
                                                                                    </strong>
                                                                                </a>
                                                                            </p>
                                                                            <img src="{{ asset('storage/'.strtolower(@$fabric->printdesign->file)) }}" height="120" style=" font-weight: 600; font-family: Madeglin, sans-serif;object-fit: cover;width: 100% !important;">
                                                                        </div>
                                                                    @endforeach
                                                                    @if($variation->trim->count() > 0)
                                                                        @foreach($variation->trim as $trim)
                                                                            <div style=" font-weight: 600; font-family: Madeglin, sans-serif;flex: 0 0 40%; max-width: 40%; position: relative;width: 100%;padding-right: 15px;padding-left: 15px;">
                                                                                ...
                                                                                <img src="{{ asset(strtolower(@$trim->trim_image)) }}" height="120" style=" font-weight: 600; font-family: Madeglin, sans-serif;object-fit: cover;width: 100% !important;">
                                                                                <p style=" font-weight: 600; font-family: Madeglin, sans-serif; margin-bottom: 0 !important; margin-top: 0.5rem !important;">
                                                                                    <label for="">
                                                                ...
                                                                <div style=" font-weight: 600; font-family: Madeglin, sans-serif;margin-bottom: 0.5rem !important; margin-top: 1rem !important;">
                                                                    <p style=" font-weight: 600; font-family: Madeglin, sans-serif; margin-bottom: 0 !important; margin-top: 0.5rem !important;">
                                                                    ...
                                                                    <p style=" font-weight: 600; font-family: Madeglin, sans-serif;color: #000000 !important; margin: 0 !important; text-transform: uppercase !important; font-size: 12px !important;">
                                                                        ...
                                                                        <span style=" font-weight: 600; font-family: Madeglin, sans-serif; color: #f36a5a;">
                                                                                Sku: {{ $variation->sku }}
                                                                            </span>
                                                                    </p>
        ...
        <div style="margin: 30px 0; border: solid 1px #333; padding: 15px; border-radius: 5px;">
            <div style="display: flex; margin-right: -15px; margin-left: -15px;">
                ...
                <div style="flex: 0 0 73.76667%; max-width: 73.76667%;position: relative; width: 100%; padding-right: 15px; padding-left: 15px;">
                    <div>
                        <h4 style="text-align: center; font-size: 16px; text-transform: uppercase; margin: 0; font-family: Madeglin, sans-serif;">Order</h4>
                        <div>
                                                    ...
                                                    @if($variation->status == 'active' && $variation->is_denim == 0)
                                                        <div style=" flex: 0 0 44.333333%; max-width: 44.333333%; position: relative; width: 100%; padding-right: 15px; padding-left: 15px;">
                                                            <div style=" min-height: 445px; background: #ffffff;  border: 1px solid #d0d0d0;  border-radius: 10px; padding-left: 1rem !important; padding-right: 1rem !important; ">
                                                                ...
                                                                <div style=" display: flex; flex-wrap:wrap;  margin-right: -15px; margin-left: -15px;">
                                                                    <div style=" min-height: 245px; flex: 0 0 40%;max-width: 40%; position: relative; width: 100%; padding-right: 15px;  padding-left: 15px;">
                                                                        ...
                                                                        <p style=" font-size: 12px !important; font-family: Madeglin, sans-serif; margin:0px !important;">
                                                                            <span for="">Notes:</span>
                                                                            {{ $variation->notes ? $variation->notes : 'None' }}
                                                                        </p>
                                                                    </div>
                                                                    @if($variation->trim->count() > 0)
                                                                        @foreach($variation->trim as $trim)
                                                                ...
                                                                <div style="margin-bottom: 0.5rem !important; margin-top: 5px !important;">

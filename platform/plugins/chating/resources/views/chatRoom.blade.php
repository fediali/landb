            ...
            <div class="container">
                                ...
                                @else
                                    <ul class="list-group list-group-flush">
                                        @foreach ($customers as $id => $customer)
                                            <a href="{{ route('chating.messages.chat', [ 'ids' => auth()->user()->id  . '-' . $id ]) }}" class="list-group-item list-group-item-action">{{ $customer }}</a>
                                        @endforeach
                                    </ul>
                                @endif
                            </div>
                ...
                <div class="row app-one">
                    ...
                    <div class="side-one">
                        ...
                        <a href="{{ route('chating.messages.chat', [ 'ids' => auth()->user()->id  . '-' . $id ]) }}"class="list-group-item list-group-item-action">
                        <div class="row msg_unread sideBar-body">

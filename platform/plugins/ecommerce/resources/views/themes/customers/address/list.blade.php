...
@section('content')
    <h2 class="customer-page-title mb-2">{{ __('Address books') }}</h2>
        ...
        <div class="row">
            ...
            @foreach($addresses as $address)
                <div class="col-md-12 col-sm-12">
                    <div
                        class="panel panel-default mt-3 dashboard-address-item @if ($address->is_default) is-address-default @endif">
                        <div class="panel-body">
                            <p class="name mb-2">{{ $address->name }} @if ($address->is_default) <span
                                    class="address-default">{{ __('Default') }}</span> @endif
                            </p>
                            <p class="address"><i class="fa fa-address-book mr-2 "
                            ...
                            <p class="phone"><i class="fa fa-phone mr-2 " aria-hidden="true"></i> {{ $address->phone }}</p>

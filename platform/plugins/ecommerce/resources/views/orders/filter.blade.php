                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input style="width: auto; margin: -7px 0.5rem 0 0;" type="checkbox" name="order_status" class="form-control" value="{{strtolower($order_status)}}"> <p class="mr-1">{{$order_status}}</p>
                            </div>
                            @endforeach
                            </div>   
                        </div>
                        <div class="col-md-12">
                            ...
                            <div style="display:inline-flex" >
                                <input style="width: auto; margin: -7px 0.5rem 0 0;" type="checkbox" name="payment_method" class="form-control" value="{{$key}}"> <p class="mr-1">{{$payment_method}}</p>
                            </div>
                            @endforeach
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="d-flex">
                            <input style="width: auto; margin: -7px 0.5rem 0 0;" type="checkbox" name="online_order" class="form-control" value="{{\Botble\Ecommerce\Models\Order::ONLINE}}">

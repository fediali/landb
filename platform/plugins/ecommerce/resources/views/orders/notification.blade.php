@php
$new = \Botble\Ecommerce\Models\Order::where('status','new')->get();
$count = \Botble\Ecommerce\Models\Order::where('status','new')->count();
    @endphp
...
{{--    @dd($orders->where('status','processing')->count())--}}
    <ul class="dropdown-menu dropdown-menu-right">
        <li class="external">
            <h3>{!! trans('plugins/ecommerce::order.new_order_notice', ['count' => $count]) !!}</h3>

            ...
            <div class="wrapper-content">
                <div class="pd-all-20 ws-nm">
                    <label class="title-product-main text-no-bold"><span
                        v-if="!is_promotion">{{ __('Create coupon code') }}</span><span
                        v-if="is_promotion">{{ __('Create discount promotion') }}</span></label>
                        ...
                        <div v-show="type_option !== 'shipping' && type_option">
                            <div class="ui-select-wrapper inline_block mb5 min-width-150-px" style="margin-right: 10px;"
                                ...
                                <select id="select-offers" class="ui-select" name="target" v-model="target">
                                    ...
                                    <option value="customer" v-if="type_option !== 'same-price'">{{ __('Customer') }}
                                    </option>
                            ...
                            <div class="inline mb5" id="div-select-category"
                                 v-if="target === 'category' && type_option !== 'shipping'" style="margin-right: 10px;">
                                <div class="ui-select-wrapper" style="min-width: 200px;">
                                    <select name="product_categories" class="ui-select" v-model="product_category_id">
                                        <option v-for="product_category in product_categories"
                                                v-bind:value="product_category.id">{{ product_category.name }}
                                        </option>
                                    </select>
                                    <svg class="svg-next-icon svg-next-icon-size-16">
                ...
                <div class="pd-all-10-20 form-group mb0">
                    ...
                    <div class="next-field__connected-wrapper z-index-9">
                        <div class="input-group date form_datetime form_datetime bs-datetime">
                            <input type="text" placeholder="Select date..." data-date-format="dd-mm-yyyy"

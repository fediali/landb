    ...
    <div class="flexbox-grid no-pd-none">
                            ...
                            <table class="table-normal">
                                ...
                                <tr v-for="variant in child_products">
                                    ...
                                    <td class="pl5 p-r5 min-width-200-px">
                                        ...
                                        <p v-if="variant.product && variant.product.sku.includes('pack')">Total Qty : {{variant.packQty}}</p>
                        ...
                        <div class="col-12 col-sm-6 col-md-12 col-lg-6">
                            <div class="flexbox-grid-default mt5 mb5">
                                ...
                                <div class="flexbox-auto-content">
                                    <div class="text-upper ws-nm">{{ __('Confirm payment and create order') }}</div>
                                </div>
                            </div>
                        </div>
                ...
                <div v-if="!child_customer_id || !child_customer">
                    <div class="next-card-section">
                        <div class="flexbox-grid-default mb15">
                            <div class="flexbox-auto-content">
                                <label class="title-product-main">{{ __('Customer information') }}</label>
                            </div>
                        </div>
        ...
        <b-modal id="add-discounts" title="Add discount" ok-title="Add discount" cancel-title="Close"
            ...
            <div class="next-form-section">
                <div class="next-form-grid">
                    <div class="next-form-grid-cell">
                        <label class="text-title-field">{{ __('Discount based on') }}</label>
                        <div class="flexbox-grid-default">
                            <div class="flexbox-auto-left">
                ...
                <div class="next-form-grid">
                    <div class="next-form-grid-cell">
                        <label class="text-title-field">{{ __('Or coupon code') }}</label>

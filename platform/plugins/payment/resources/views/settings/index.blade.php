                                ...
                                <div class="col-sm-12">
                                    <div class="well bg-white">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="next-input" name="payment_cod_description" id="payment_cod_description">{{ setting('payment_cod_description') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 bg-white text-right">
                                ...
                                <div class="col-sm-12">
                                    <div class="well bg-white">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="next-input" name="payment_bank_transfer_description" id="payment_bank_transfer_description">{{ setting('payment_bank_transfer_description') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 bg-white text-right">

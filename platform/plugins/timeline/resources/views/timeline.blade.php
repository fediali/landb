    ...
    <div class="">
        ...
        <div id="main">
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="main-form">
                        <div style="background: #f1f1f1; padding: 15px; margin-bottom: 15px;   border-radius: 10px;"
                             class="form-body">
                ...
                <div class="col-md-3 right-sidebar">
                    ...
                    <div class="widget meta-boxes">
                        ...
                        <div class="widget-body">
                            ...
                            {{--                                   type="text" id="name">--}}
                            {!! Form::text('name', null, ['class' => 'form-control', 'placeholder'=>'Timeline Name' ,'id'=>'name' ,'required']) !!}

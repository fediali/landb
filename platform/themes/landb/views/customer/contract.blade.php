                ...
                <div class="col-lg-12">
                    ...
                    <form method="POST" action="{{ route('customer.edit-account-post', 'tax_certificate') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="d-flex">
                                    <input class="mt-1 mr-2 checkk" id="check1" type="checkbox" value="1" name="first_check">
                            ...
                            <div class="col-lg-12">
                                <div class="d-flex">
                                    <input class="mt-1 mr-2 checkk"  id="check2" type="checkbox" value="1" name="second_check">
                            ...
                            <div class="col-lg-12">
                                <div class="d-flex">
                                    <input class="mt-1 mr-2 checkk" id="check3" type="checkbox" value="1" name="last_check">
                        ...
                        <div class="col-lg-2">
                            <input type="submit" class="btn border-btn w-100 tax-submit-btn" value="Submit">
                        </div>
                        <div class="col-lg-5"></div>
                    </div>
                    </form>

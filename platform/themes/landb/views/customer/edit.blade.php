    ...
    <div class="row">
        <div class="col-lg-12 mt-2">
            <ul class="nav nav-tabs tabs-product">
                <li class="mt-4"><a class="{{ ($tab == 'general') ? 'active': '' }}" data-toggle="tab" href="#home">General&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                </li>
                <li class="mt-4"><a class="{{ ($tab == 'shipping') ? 'active': '' }}" data-toggle="tab" href="#menu1">Shipping
                        Address&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
                <li class="mt-4"><a class="{{ ($tab == 'tax_certificate') ? 'active': '' }}" data-toggle="tab"
                                    href="#menu2">Tax Certificate Online&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                </li>
                <li class="mt-4"><a class="{{ ($tab == 'store_locator') ? 'active': '' }}" data-toggle="tab"
                                    href="#menu3">Store Locator</a></li>
            </ul>
                            ...
                            <form method="POST" action="{{ route('customer.edit-account-post', 'account') }}">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <input
                                            class="input-textbox form-control @error('first_name') is-invalid @enderror"
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input
                                            class="input-textbox form-control @error('last_name') is-invalid @enderror"
...
{{--                                        @isset($type)--}}
                                            @foreach(\Botble\Ecommerce\Models\Customer::$customerType as $type)
                                                ...
                                                <input class="ml-2" type="checkbox" name="customer_type[]"
                                                       value="{{ $type }}"
...
{{--                                        @endisset--}}
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select class="input-textbox" name="hear_us">
                                            <option @if(is_null($user->details->hear_us)) selected @endif disabled
                                                    hidden>Select an Option
                                            </option>
                                    ...
                                    <div class="col-lg-3 mt-3">
                                        ...
                                        <input class=" btn cart-btn w-100" type="submit" placeholder="Save"
                                               value="Save"/>
                                    </div>
                                    <div class="col-lg-3 mt-3">
                        ...
                        <div class="col-lg-5">
                            <div class="refer-area">
                                ...
                                <p class="refer-link-para mt-3">Invite a friend to L&B and get rewards for the first
                                    order of every person!</p>
                                <input class="mt-3 textbox-refer" type="text"
                                       value="http://landbapparel.com/profiles-add.html?ref_code=2447461738"/>
                                <div class="mt-3">
                            ...
                            <form method="POST" action="{{ route('customer.edit-account-post', 'address') }}">
                                ...
                                <div class="row">
                                    <input type="hidden" name="shipping_id"
                                           value="{{ @$user->shippingAddress[0]->id }}">
                                    <div class="col-lg-6">
                                        <p class="textbox-label">First Name</p>
                                        <input
                                    ...
                                    <div class="col-lg-12">
                                        <div class="shipping-checkbox-area mt-2 d-flex">
                                            ...
                                            <div class="ml-3">
                                                <input class="ml-2" type="radio" name="billing" value="1"
                                                       data-toggle="collapse" data-target=".collapseOne.show">
                                                <label class="mr-2 mb-0" for="vehicle1"> Yes</label>
                                                <input class="ml-2" type="radio" name="billing" value="0"
                                                       data-toggle="collapse" data-target=".collapseOne:not(.show)"
                                                       checked>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <select
                                                                ...
                                                                <option selected hidden disabled>Select a Country
                                                                </option>
                                                                @foreach(get_countries() as $key => $country)
                                                                    <option
                ...
                <div id="menu2" class="tab-pane fade {{ ($tab == 'tax_certificate') ? 'in active show': '' }}">
                    <form method="POST" action="{{ route('customer.edit-account-post', 'tax_certificate') }}">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="refer-area mt-4">
                                    <div class="row">
                                        <div class="col-lg-7">
                                            <p class="textbox-label">Name of purchaser, firm or agency as shown on
                                                permit </p>
                                            <input
                                                class="input-textbox bg-white form-control @error('purchaser_name') is-invalid @enderror"
                                                type="text" name="purchaser_name"
                                                value="{{ old('purchaser_name',@$user->taxCertificate->purchaser_name) }}"/>
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <input
                                                class="input-textbox bg-white form-control @error('purchaser_phone') is-invalid @enderror"
                                                type="text" name="purchaser_phone"
                                                value="{{ old('purchaser_phone',@$user->taxCertificate->purchaser_phone) }}"/>
                                            @error('purchaser_phone')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-lg-12">
                                            <p class="textbox-label">Address (Street & number, P.O. Box or Route
                                                number)</p>
                                            <input
                                                class="input-textbox bg-white form-control @error('purchaser_address') is-invalid @enderror"
                                                type="text" name="purchaser_address"
                                                value="{{ old('purchaser_address',@$user->taxCertificate->purchaser_address) }}"/>
                                        ...
                                        <div class="col-lg-7">
                                            ...
                                            <input
                                                class="input-textbox bg-white form-control @error('purchaser_city') is-invalid @enderror"
                                                type="text" name="purchaser_city"
                                                value="{{ old('purchaser_city',@$user->taxCertificate->purchaser_city) }}"/>
                                            @error('purchaser_city')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-lg-5">
                                            <p class="textbox-label">Texas Sales and Use Tax Permit Number (must contain
                                                11 digits)</p>
                                            <input
                                                class="input-textbox bg-white form-control @error('permit_no') is-invalid @enderror"
                                                type="text" name="permit_no"
                                                value="{{ old('permit_no',@$user->taxCertificate->permit_no) }}"/>
                                            @error('permit_no')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-lg-12">
                                            <p class="textbox-label">Out-of-state retailer”s registration number or
                                                Fedral Taxpayers Registry (RFC) number for retailers based in Mexico</p>
                                            <input
                                                class="input-textbox bg-white form-control @error('registration_no') is-invalid @enderror"
                                                type="text" name="registration_no"
                                                value="{{ old('registration_no',@$user->taxCertificate->registration_no) }}"/>
                                            @error('registration_no')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-lg-12">
                                            <h4 class="profile-light-txt mt-4">(Retailers based in Mexico must also
                                                provide a copy of their Mexico registration form to the seller.)</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="refer-area mt-4">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <h4 class="profile-light-txt mt-4">I, the purchaser named above, claim the
                                                right to make a non-taxable purchase (for resale of the taxable items
                                        ...
                                        <div class="col-lg-12">
                                            <p class="textbox-label">Description of items to be purchased on the
                                                attached order or invoice.</p>
                                            <textarea rows="4"
                                                      class="input-textbox bg-white form-control @error('items_description') is-invalid @enderror"
                                                      name="items_description">{{ old('items_description',@$user->taxCertificate->items_description) }}</textarea>
                                            @error('items_description')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-lg-12">
                                            <p class="textbox-label">Description of the type of business activity
                                                generally engaged in or type of items normally sold by the
                                                purchaser.</p>
                                            <textarea rows="4"
                                                      class="input-textbox bg-white form-control @error('business_description') is-invalid @enderror"
                                                      name="business_description">{{ old('business_description',@$user->taxCertificate->business_description) }}</textarea>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="d-flex checkbox-contract">
                                                ...
                                                <label class="mr-2 tax-checkbox-label" for="vehicle1"> The taxable items
                                                    ...
                                                    resold, rented or leased by me within the geographical limits of the
                                                    United States of America, its territories and possessions or within
                                                    the geographical limits of the United Mexican States, in their
                                        ...
                                        <div class="col-lg-12">
                                            <div class="d-flex checkbox-contract">
                                                ...
                                                <label class="mr-2 tax-checkbox-label" for="vehicle1"> I understand that
                                                    ...
                                                    display while holding them for sale, lease or rental, I must pay
                                                    sales tax on the the items at the time of use based upon either the
                                                    purchase price or the fair market rental value for the period of
                                                    time used.</label>
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="d-flex checkbox-contract">
                                                ...
                                                <label class="mr-2 tax-checkbox-label" for="vehicle1"> I understand that
                                                    ...
                                                    for taxable items that i know, at the time of purchase, are
                                                    purchased for use rather than for the purpose of resale, lease or
                                                    rental, and depending on the amount of tax evaded, the offence may
                                                    range from a Class C misdemeanor to a felony of the second
                                                    degree.</label>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('title',@$user->taxCertificate->title) }}"/>
                                            @error('title')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-lg-5">
                                            ...
                                            <input
                                                ...
                                                type="date" name="date"
                                                value="{{ old('date',@$user->taxCertificate->date) }}"/>
                                            @error('date')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-12">
                                <p class="cert-label">This certificate should be furnished to the supplier. Do not send
                                    the completed certificate to the Comptroller of Public Accounts.</p>
                        ...
                        <div class="col-lg-6">
                            <form method="POST" action="{{ route('customer.edit-account-post', 'store_locator') }}">
                                ...
                                <div class="d-flex">
                                    ...
                                    <label class="mr-2 tax-checkbox-label" for="vehicle1"> Add me to the Store
                                        Locator </label>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <p class="textbox-label">Company Name</p>
                                        <input
                                            class="input-textbox form-control @error('locator_company') is-invalid @enderror"
                                            type="text" name="locator_company"
                                            value="{{ old('locator_company',@$user->storeLocator->locator_company) }}"/>
                                    ...
                                    <div class="col-lg-6">
                                        <p class="textbox-label">Mobile</p>
                                        <input
                                            class="input-textbox form-control @error('locator_phone') is-invalid @enderror"
                                            type="text" name="locator_phone"
                                            value="{{ old('locator_phone',@$user->storeLocator->locator_phone) }}"/>
                                        @error('locator_phone')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <input
                                            class="input-textbox form-control @error('locator_website') is-invalid @enderror"
                                            type="text" name="locator_website"
                                            value="{{ old('locator_website',@$user->storeLocator->locator_website) }}"/>
                                    ...
                                    <div class="col-lg-12">
                                        <p class="textbox-label">Address</p>
                                        <input
                                            class="input-textbox form-control @error('locator_address') is-invalid @enderror"
                                            type="text" name="locator_address"
                                            value="{{ old('locator_address',@$user->storeLocator->locator_address) }}"/>
                                        @error('locator_company')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-lg-6">
                                        <p class="textbox-label">City</p>
                                        <input
                                            class="input-textbox form-control @error('locator_city') is-invalid @enderror"
                                            type="text" name="locator_city"
                                            value="{{ old('locator_city',@$user->storeLocator->locator_city) }}"/>
                                        @error('locator_city')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <select
                                            class="input-textbox form-control  @error('locator_country') is-invalid @enderror"
                                            name="locator_country">
                                            <option selected hidden disabled>Select a Country</option>
                                            @foreach(get_countries() as $key => $country)
                                                <option
                                                    @if(old('locator_country',@$user->storeLocator->locator_country) == $key) selected
                                                    @endif value="{{ $key }}">{{ $country }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select
                                            class="input-textbox form-control  @error('locator_state') is-invalid @enderror"
                                            name="locator_state">
                                            <option selected hidden disabled>Select a State</option>
                                            @foreach(get_states(@$user->storeLocator->locator_country) as $key => $state)
                                                <option
                                                    @if(old('locator_state',@$user->storeLocator->locator_state ) == $key) selected
                                                    @endif value="{{ $key }}">{{ $state }}</option>
                                            @endforeach
                                        </select>
                                        @error('locator_state')
                                    ...
                                    <div class="col-lg-6">
                                        <p class="textbox-label">Zip/Postal Code</p>
                                        <input
                                            class="input-textbox form-control @error('locator_zip_code') is-invalid @enderror"
                                            type="text" name="locator_zip_code"
                                            value="{{ old('locator_zip_code',@$user->storeLocator->locator_zip_code) }}"/>
                                    ...
                                    <div class="col-lg-5">
                                        <p class="textbox-label">Customer Type</p>
                                        <input
                                            class="input-textbox form-control @error('locator_customer_type') is-invalid @enderror"
                                            type="text" name="locator_customer_type"
                                            value="{{ old('locator_customer_type',@$user->storeLocator->locator_customer_type) }}"/>

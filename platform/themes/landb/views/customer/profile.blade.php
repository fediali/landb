    ...
    <div class="row">
        <div class="col-lg-12 mt-2">
            ...
            <div id="Dashboard" class="tabcontent">
                <p class="mt-3">From your account dashboard you can view your <a href="#" class="color-black" onclick="openCity(event, 'Orders')">recent orders,</a> manage your <a href="#" class="color-black" onclick="openCity(event, 'Addresses')">shipping and billing addresses</a>,
                    and edit your <a href="#" class="color-black" onclick="openCity(event, 'Account')">password and account details.</a></p>
            </div>

...
class updateProductPackQtyActive extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'update:active-prod-qty';
     ...
     * @var string
     */
    protected $description = 'Update Active Product Qty';
    ...
    {
        $products = DB::connection('mysql2')->table('hw_products')->where('status', 'A')->get();

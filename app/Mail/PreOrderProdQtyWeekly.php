...
use App\Exports\SumPreOrderProdExportWeekly;
use Illuminate\Bus\Queueable;
use Illuminate\Mail\Mailable;
use Illuminate\Queue\SerializesModels;
use Maatwebsite\Excel\Facades\Excel;

class PreOrderProdQtyWeekly extends Mailable
{
    ...
    public function build()
    {
        ...
        ->attach(Excel::download(new SumPreOrderProdExportWeekly, 'sum-'.$fileName)->getFile(), ['as' => 'sum-'.$fileName]);
